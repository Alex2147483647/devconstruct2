...
!function (a) {
    ...
    a.event.special.destroyed || (a.event.special.destroyed = {
        ...
        maxlength: function (b, c) {
            ...
            function l(a, c, d, e) {
                e.html(k(d, d - a)), a > 0 ? g(c, b.threshold, d) ? i(e.removeClass(b.limitReachedClass).addClass(b.warningClass)) : j(e) : i(e.removeClass(b.warningClass).addClass(b.limitReachedClass)), b.allowOverMax && (0 > a ? c.addClass("overmax") : c.removeClass("overmax"))
            }
            ...
            function n(a, c) {
                var d = m(a), e = a.outerWidth(), f = c.outerWidth(), g = c.width(), h = c.height();
