...
!function (a) {
        ...
        if (this.template = void 0 !== this.options.template ? this.options.template : '<table class="table gtreetable"><tr class="' + this.options.classes.node + " " + this.options.classes.collapsed + '"><td><span>${draggableIcon}${indent}${ecIcon}${selectedIcon}${typeIcon}${name}</span><span class="hide ' + this.options.classes.action + '">${input}${saveButton} ${cancelButton}</span><div class="btn-group pull-right ' + this.options.classes.buttons + '">${actionsButton}${actionsList}</div></td></tr></table>', this.templateParts = void 0 !== this.options.templateParts ? this.options.templateParts : {
            ...
            a.each(this.actions, function (a, b) {
                if (b.divider === !0)f += '<li class="divider"></li>'; else {
                    var c = b.name.match(/\$\{([\w\W]+)\}/), d = null !== c && void 0 !== c[1] && void 0 !== e.actions[c[1]] ? e.actions[c[1]] : b.name;
    ...
    function e(c, d) {
        ...
        return this.each(function () {
            var f = a(this), g = f.data("bs.gtreetable"), h = a.extend({}, a.fn.gtreetable.defaults, f.data(), "object" == typeof c && c);
    ...
    b.prototype = {
        ...
        getSourceNodes: function (b, c) {
            var d = this, e = this.getNodeById(b), f = b > 0 && this.options.cache > 0;
            if (f && c !== !0) {
        ...
        getPath: function () {
            var b = this, c = [b.name], d = b.parent;
        ...
        getDescendants: function (b) {
            var c = this, d = a.extend({}, {
                ...
                includeNotSaved: !1,
                index: void 0
            }, b), e = "." + c.manager.options.classes.node, f = -1 !== d.depth || isNaN(d.depth) ? d.depth : 1 / 0, g = [];
        ...
        attachEvents: function () {
            var b = this, c = parseInt(this.manager.options.selectLimit);
            if (this.$node.mouseover(function () {
                    ...
                    b.isExpanded() ? b.collapse() : b.expand({isAltPressed: a.altKey})
                ...
                var d = function (a, c) {
                    var d, e = a.offset.top - c.offset().top, f = c.offset().top, g = c.outerHeight(), h = g - Math.round(a.helper.outerHeight() / 2), i = {left: b.manager.$tree.offset().left + 5};
                ...
                this.$node.draggable({
                    ...
                    drag: function (c, e) {
                        if (!a.browser.webkit) {
                            var f = a(window).scrollTop(), g = a(this).data("bs.gtreetable.gtreetablenode.scrollTop") - f;
                    ...
                    drop: function (c, d) {
                        var e = a(this), f = b.manager.getNode(e), g = f.getMovePosition();
        ...
        _canAdd: function (a) {
            var b = {result: !(0 === a.parent && this.manager.options.manyroots === !1)};
        ...
        add: function (a, b) {
            ...
            var e = this, f = "lastChild" === a || "firstChild" === a, g = new c({
                level: e.level + (f ? 1 : 0),
                parent: e.level !== this.manager.options.rootLevel || f ? f ? e.id : e.parent : 0,
                type: b
            }, this.manager), h = this._canAdd(g);
        ...
        move: function (b, c) {
            var d = this, e = this._canMove(b, c);
        ...
        _move: function (b, c) {
            var d = this, e = d.getDescendants({
                depth: -1,
                includeNotSaved: !0
            }), f = a.extend({}, d), g = d.getIP(), h = b.level - d.level;
        ...
        sort: function () {
            var b = this, c = b.getSiblings();
            if (c.length > 0) {
                var d, e = b.isExpanded() ? b.getDescendants({
                    depth: -1,
                    includeNotSaved: !0
                }) : [];
                a.each(c, function () {
        ...
        _synchronizeMove: function (b, c) {
            var d = this, e = b.getIP(), f = b.level - c.oOldNode.level;
            a.each(this._cached, function (b) {
                if (b === c.oldIP || 0 === b.indexOf(c.oldIP + ".")) {
                    if (d.manager.options.cache > 1) {
                        var g = [], h = b !== c.oldIP ? e + b.substr(c.oldIP.length) : e;
