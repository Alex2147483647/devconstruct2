...
(function () {
    ...
    (function () {
        ...
        var n = function () {
            ...
            var h = CKEDITOR.dtd, s = {
                ...
                h5: 1,
                h6: 1
            }, p = CKEDITOR.tools.extend({}, h.$inline);
            delete p.br;
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, f, i, g = b.duplicate(), l = 0, h = e.length - 1, A = -1, j, v; l <= h;) {
                            ...
                            j = g.compareEndPoints("StartToStart",
                                b);
                            if (j > 0)h = A - 1; else if (j < 0)l = A + 1; else return {
                                container: d,
                                offset: a(f)
                            }
                        }
    ...
    (function () {
        var g = [CKEDITOR.CTRL + 90, CKEDITOR.CTRL + 89, CKEDITOR.CTRL + CKEDITOR.SHIFT + 90], l = {
            8: 1,
            46: 1
        };
