    ...
    n.fn.rateit = function (i, r) {
        ...
        return this.each(function () {
            ...
            if (i == "reset") {
                ...
                f("backingfld") && (h = n(f("backingfld")), h.val(f("value")), h[0].min && (h[0].min = f("min")), h[0].max && (h[0].max = f("max")), h[0].step && (h[0].step = f("step")));
                c.trigger("reset")
            }
            ...
            a.data("wired") !== !0 && a.bind("click", function (n) {
                n.preventDefault();
                a.blur();
                c.rateit("value", null);
                c.trigger("reset")
            ...
            var nt = function (t, i) {
                ...
                f("value", t);
                f("backingfld") && n(f("backingfld")).val(t);
                f("ispreset") && (l.find(".rateit-selected").removeClass(y), f("ispreset", !1));
                l.find(".rateit-hover").hide();
                l.find(".rateit-selected").width(t * f("starwidth") - f("min") * f("starwidth")).show();
                c.trigger("hover", [null]).trigger("over", [null]).trigger("rated", [t])
            };
